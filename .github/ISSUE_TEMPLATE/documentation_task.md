...
about: "Create or update project documentation"
title: "[DOCS] "
...
<!-- List the file(s) to be created or changed, e.g.
hardware/CardioCore_V1/Project_Specification.md, docs/Design_Decisions_Log.md,
docs/Blockers.md, README.md. Use repo-relative paths. -->

-

## What needs adding or changing

<!-- Describe the specific content to add, revise, or remove. Be concrete:
sections, tables, figures, terminology. -->

## Why

<!-- Reason for the change: new decision recorded, blocker status update,
clarification, correction, missing context, etc. -->

## Sources / references

<!-- Cite the basis for the content so it can be verified:
- Design decision IDs (D1-D12) from the Design Decisions Log
- Blocker IDs (B1-B16) from the Blockers list
...
- [ ] Consistent with the Blockers list (B1-B16); open items remain marked open.
